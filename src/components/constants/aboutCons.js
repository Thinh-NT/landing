export const aboutCons = {
  ...
  KO: {
    ...
    vision: {
      heading: "Vision",
      content:
        "베트남은 해외무역과 경제교류를 확대하고 있습니다. 이에 국제적인 관세이슈로서 FTA 원산지, 비관세장벽, 덤핑관세, 세이프가드 등 다양한 이슈들이 발생하고 있습니다.이러한 이슈들은 수출입통관 실무와 연계되어 있습니다. 따라서, 회계법인, 법무법인에서 정확한 자문이 어렵습니다. 저희 UNI에서는 관련 규정과 함께 실무 관행까지 검토하여 정확한 관세 자문을 제공하고 있습니다.",
    },
    ourMission: {
      heading: "Our Mission",
      content:
        '베트남에서는 복잡하고 다양한 관세 문제들이 발생하고 있습니다. 일반 물류회사 수준에서는 관세문제를 정확히 대응하기 어려운 경우가 많습니다. UNI는 "베트남 관세 전문가"로서 베트남 수출입 통관 및 세관감사 대응 등 모든 관세 실무를 정확하게 처리하고 있습니다.',
    },
  },
};
